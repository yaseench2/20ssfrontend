    ...
    <div class="container mb-4 d-none">
        <article class="card">
            <div class="card-body">
                ...
                <ul class="row">
                    <li class="col-md-4">
                        <figure class="itemside mb-3">
                            ...
                            <figcaption class="info align-self-center">
                                <p class="title">Dell Laptop with 500GB HDD <br> 8GB RAM</p> <span class="text-muted">$950
                                </span>
                            </figcaption>
                        </figure>
                    </li>
                    <li class="col-md-4">
                        <figure class="itemside mb-3">
                            ...
                            <figcaption class="info align-self-center">
                                <p class="title">HP Laptop with 500GB HDD <br> 8GB RAM</p> <span class="text-muted">$850
                                </span>
                            </figcaption>
                        </figure>
                    </li>
                    <li class="col-md-4">
                        <figure class="itemside mb-3">
                            ...
                            <figcaption class="info align-self-center">
                                <p class="title">ACER Laptop with 500GB HDD <br> 8GB RAM</p> <span class="text-muted">$650
                                </span>
                            </figcaption>
                        </figure>
                    </li>
                ...
                <hr>
                <router-link to="/"><a href="#" class="btn btn-dark" data-abc="true"> <i class="fa fa-chevron-left"></i> Back</a></router-link>
